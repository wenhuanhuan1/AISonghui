...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HXPhotoPicker-Lite/HXPhotoPicker_Lite.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/KNPhotoBrowser/KNPhotoBrowser.framework"
